...
kable(cbind(mpg.merc$manufacturer, mpg.merc$model, mpg.merc$cty, mpg.merc$hwy), booktabs=T,
      caption = "Mileage data for Merc in mpg",
      col.names=c("Manufacturer", "Model","City miles per gallown",
                  "Highways miles per gallon"),align = "c") %>% 
  kable_styling(latex_options = "hold_position")
```

```{r echo=FALSE}
mtcars.2 <- mtcars.1[8:14,]
kable(cbind(mtcars.2$model, mtcars.2$mpg) , booktabs=T,
      caption = "Mileage data for Merc in mtcars",
      col.names=c("Model","Miles/(US)gallon"), align="c") %>%
  kable_styling(latex_options = "hold_position")
```
