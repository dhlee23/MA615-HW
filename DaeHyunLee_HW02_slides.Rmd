...
tbl_1 <- cbind(class, cty_mean,hwy_mean)      ## form an array for the table
                            ...
                            ## changed from "latex" to "markdown"
knitr::kable(tbl_1, format = "markdown", booktabs=TRUE, digits = 2,     ## call kable to make the table
...
colnames(tbl_2) <- c('Model', 'Milage', 
                     ...
                     "Model", "Milage"
                               ...
                               ##format changed from "latex" to "html"
...
## Boxplots: City MPG by Class of Car: 1999, 2008
...
## Boxplots: Highway MPG by Class of Car: 1999, 2008
